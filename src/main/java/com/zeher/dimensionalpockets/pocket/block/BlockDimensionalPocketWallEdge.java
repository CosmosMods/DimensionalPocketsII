...
import com.zeher.zeherlib.mod.block.ModBlockConnected;
...
public class BlockDimensionalPocketWallEdge extends ModBlockConnected {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (playerIn.dimension == DimensionalPockets.DIMENSION_ID && playerIn.isSneaking() && playerIn.getHeldItem(EnumHand.MAIN_HAND).isEmpty()) {
			if (worldIn.isRemote) {
				return false;
			}
