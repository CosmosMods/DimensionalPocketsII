...
public class DimReference {
	...
	/**
	 * Constant values. Not to be messed with!
	 */
	...
	public static class GUI {
		public static class RESOURCE {
			public static final ResourceLocation GUI_POCKET = new ResourceLocation(DimReference.RESOURCE.GUI + "gui_pocket_main.png");
			public static final ResourceLocation GUI_POCKET_SLOTS = new ResourceLocation(DimReference.RESOURCE.GUI + "gui_pocket_slots.png");
			
			public static final ResourceLocation GUI_CONNECTOR = new ResourceLocation(DimReference.RESOURCE.GUI + "gui_connector_main.png");
			public static final ResourceLocation GUI_CONNECTOR_SLOTS = new ResourceLocation(DimReference.RESOURCE.GUI + "gui_connector_slots.png");
	...
	public static class DEPENDENCY {
		...
		private static final String ZEHERLIB_REQ = "7.1.30";
		private static final String ZEHERLIB_REQ_MAX = "7.2.0";
