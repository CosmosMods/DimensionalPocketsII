...
public class ModWorldGenManager implements IWorldGenerator {
	...
	private void generateOverworld(World world, Random random, int blockXPos, int blockZPos) {
		this.addOreSpawn(ModBlockManager.BLOCK_DIMENSIONAL_ORE.getDefaultState(), world, random, blockXPos, blockZPos, 16, 16, 4, 10, 5, 50, BlockMatcher.forBlock(Blocks.STONE));
	}
