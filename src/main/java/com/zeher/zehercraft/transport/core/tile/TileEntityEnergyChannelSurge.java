...
public class TileEntityEnergyChannelSurge extends TileEntity implements IChannel.Energy, ITickable, IEnergyReceiver, IEnergyProvider, ChannelType.IChannelEnergy {
