...
public class TileEntityEnergyChannelTransparent extends TileEntity implements IChannel.Energy, ITickable, IEnergyReceiver, IEnergyProvider, ChannelType.IChannelEnergy {
