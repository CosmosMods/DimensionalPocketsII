...
public class BlockEnergyChannelTransparent extends BlockContainerRemovable {
	...
	public BlockEnergyChannelTransparent(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityEnergyChannelTransparent();
	}
	...
	public void onBlockClicked(World world, BlockPos pos, EntityPlayer player) {
		...
		if (tile instanceof TileEntityEnergyChannelTransparent) {
			System.out.println(((TileEntityEnergyChannelTransparent) tile).getSideArray());
			
			System.out.println(((TileEntityEnergyChannelTransparent) tile).storage.getMaxEnergyStored() + " | " + ((TileEntityEnergyChannelTransparent) tile).storage.getEnergyStored() + " | " + ((TileEntityEnergyChannelTransparent) tile).getLastFacing());
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hit_x, float hit_y, float hit_z) {
		...
		if (ModUtil.isHoldingHammer(player) && !player.isSneaking()) {
			...
			if (tile instanceof TileEntityEnergyChannelTransparent && tile != null) {
				((TileEntityEnergyChannelTransparent) tile).cycleSide(facing);
			}
		}
		return false;
	}
