...
import com.zeher.zehercraft.processing.client.container.slot.SlotGrinder;
...
public class ContainerGrinder extends Container {
	...
	public ContainerGrinder(InventoryPlayer invPlayer, IInventory tile) {
		this.inventory = tile;
		...
		//Output Slot
		this.addSlotToContainer(new SlotGrinder(invPlayer.player, tile, 1, 104, 58));
