...
public class GuiSeparator extends GuiContainer {
	...
	private TileEntitySeparator INVENTORY;

	public GuiSeparator(InventoryPlayer inv_player, TileEntitySeparator tile) {
		super(new ContainerSeparator(inv_player, tile));
		this.INVENTORY = tile;
	...
	protected void drawGuiContainerBackgroundLayer(float ticks, int mouse_x, int mouse_y) {
		...
		ModGuiUtil.DRAW.drawBackground(this, screen_coords, ZCReference.RESOURCE.PROCESSING.SEPARATOR_LOC_GUI);
