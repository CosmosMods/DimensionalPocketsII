...
public class GuiKiln extends GuiContainer {
	...
	private TileEntityKiln INVENTORY;

	public GuiKiln(InventoryPlayer inv_player, TileEntityKiln tile) {
		super(new ContainerKiln(inv_player, tile));
		this.INVENTORY = tile;
	...
	protected void drawGuiContainerBackgroundLayer(float ticks, int mouse_x, int mouse_y) {
		...
		ModGuiUtil.DRAW.drawBackground(this, screen_coords, ZCReference.RESOURCE.PROCESSING.KILN_LOC_GUI);
