...
import com.zeher.zehercraft.processing.client.container.slot.SlotSeparator;
...
public class ContainerSeparator extends Container {
	...
	public ContainerSeparator(InventoryPlayer invPlayer, IInventory tile) {
		this.inventory = tile;
		...
		//Output Slot
		this.addSlotToContainer(new SlotSeparator(invPlayer.player, tile, 1, 104, 58));

		//Secondary Output Slot
		this.addSlotToContainer(new Slot(tile, 2, 147, 50));
