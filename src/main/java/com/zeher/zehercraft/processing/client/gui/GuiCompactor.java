...
public class GuiCompactor extends GuiContainer {
	...
	private TileEntityCompactor INVENTORY;

	public GuiCompactor(InventoryPlayer inv_player, TileEntityCompactor tile) {
		super(new ContainerCompactor(inv_player, tile));
		this.INVENTORY = tile;
	...
	protected void drawGuiContainerBackgroundLayer(float ticks, int mouse_x, int mouse_y) {
		...
		ModGuiUtil.DRAW.drawBackground(this, screen_coords, ZCReference.RESOURCE.PROCESSING.COMPACTOR_LOC_GUI);
