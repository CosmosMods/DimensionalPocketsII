...
public enum EnumShiftDirection {
	...
	public static final EnumShiftDirection[] VALID_DIRECTIONS = {
	...
	private EnumShiftDirection(int x, int y, int z) {
		offsetX = x;
		offsetY = y;
		offsetZ = z;
	}
	...
	public static EnumShiftDirection getValidTeleportLocation(World world, BlockPos pos) {
		for (EnumShiftDirection direction : VALID_DIRECTIONS) {
