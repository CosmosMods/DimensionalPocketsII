...
public class EnergyWidgetCustom extends Widget {
	...
	public EnergyWidgetCustom(int x, int y, int widthIn, int heightIn, ITextComponent buttonText) {
	...
	public void drawButton(MatrixStack stack, int mouseX, int mouseY, float ticks) {
		if (this.visible) {
			...
			minecraft.getTextureManager().bindTexture(CosmosReference.RESOURCE.BASE.GUI_ENERGY_BUTTON_CUSTOM_LOC);
