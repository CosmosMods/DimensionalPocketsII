...
public class FluidWidgetCustom extends Widget {
	...
	public FluidWidgetCustom(int x, int y, int widthIn, int heightIn, ITextComponent buttonText) {
	...
	public void drawButton(MatrixStack stack, int mouseX, int mouseY, float ticks) {
		if (this.visible) {
			...
			minecraft.getTextureManager().bindTexture(CosmosReference.RESOURCE.BASE.GUI_FLUID_BUTTON_CUSTOM_LOC);
