...
public class DimensionalTridentEntity extends AbstractArrowEntity {
	private static final DataParameter<Byte> ID_LOYALTY = EntityDataManager.defineId(DimensionalTridentEntity.class, DataSerializers.BYTE);
	private static final DataParameter<Boolean> ID_FOIL = EntityDataManager.defineId(DimensionalTridentEntity.class, DataSerializers.BOOLEAN);
	private ItemStack tridentItem = new ItemStack(CoreModBusManager.DIMENSIONAL_TRIDENT);
	private boolean dealtDamage;
	public int clientSideReturnTridentTickCount;

	public DimensionalTridentEntity(EntityType<? extends DimensionalTridentEntity> entityTypeIn, World worldIn) {
		super(entityTypeIn, worldIn);
	}

	public DimensionalTridentEntity(World worldIn, LivingEntity livingEntityIn, ItemStack stackIn) {
		super(CoreModBusManager.TRIDENT_TYPE, livingEntityIn, worldIn);
	...
	@OnlyIn(Dist.CLIENT)
	public DimensionalTridentEntity(World worldIn, double x, double y, double z) {
		super(CoreModBusManager.TRIDENT_TYPE, x, y, z, worldIn);
	}
	...
	public void playerTouch(PlayerEntity playerIn) {
		Entity entity = this.getOwner();
		if (entity == null || entity.getUUID() == playerIn.getUUID()) {
	...
	public void addAdditionalSaveData(CompoundNBT compound) {
		...
		compound.put("Trident", this.tridentItem.save(new CompoundNBT()));
