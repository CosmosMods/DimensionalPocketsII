...
import com.tcn.cosmoslibrary.energy.item.CosmosEnergySword;
...
public class DimensionalSword extends CosmosEnergySword {
	
	public boolean enhanced;

	public DimensionalSword(Tier itemTier, int attackDamageIn, float attackSpeedIn, boolean enhanced, Properties builderIn, CosmosEnergyItem.Properties energyProperties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		if (!ComponentHelper.isShiftKeyDown(Minecraft.getInstance())) {
			if (this.enhanced) {
				tooltip.add(ComponentHelper.getTooltipInfo("dimensionalpocketsii.item.info.sword_enhanced"));
			} else {
				tooltip.add(ComponentHelper.getTooltipInfo("dimensionalpocketsii.item.info.sword"));
			}
