...
import com.tcn.cosmoslibrary.energy.item.CosmosEnergyPickaxe;
...
public class DimensionalPickaxe extends CosmosEnergyPickaxe {
	
	public boolean enhanced;

	public DimensionalPickaxe(Tier itemTier, int attackDamageIn, float attackSpeedIn, boolean enhanced, Properties builderIn, CosmosEnergyItem.Properties energyProperties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		if (!ComponentHelper.isShiftKeyDown(Minecraft.getInstance())) {
			if (this.enhanced) {
				tooltip.add(ComponentHelper.getTooltipInfo("dimensionalpocketsii.item.info.pickaxe_enhanced"));
			} else {
				tooltip.add(ComponentHelper.getTooltipInfo("dimensionalpocketsii.item.info.pickaxe"));
			}
