...
public class DimensionalShifterEnhanced extends Item {
	...
	public DimensionalShifterEnhanced(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (!CosmosCompHelper.isShiftKeyDown(Minecraft.getInstance())) {
			...
			tooltip.add(CosmosCompHelper.getTooltipFour("dimensionalpocketsii.info.shifter_enhanced"));
		...
		if (stack.hasTag()) {
			if (!CosmosCompHelper.isControlKeyDown(Minecraft.getInstance())) {
				...
				if (tag.contains("player_pos")) {
					...
					//tooltip.add(new StringTextComponent(CColour.GRAY + "Pocket Source Dimension: " + CColour.LIGHT_GRAY
				}
