...
import com.tcn.cosmoslibrary.energy.item.CosmosEnergyShovel;
...
public class DimensionalShovel extends CosmosEnergyShovel {
	
	public boolean enhanced;

	public DimensionalShovel(Tier itemTier, int attackDamageIn, float attackSpeedIn, boolean enhanced, Properties builderIn, CosmosEnergyItem.Properties energyProperties) {
