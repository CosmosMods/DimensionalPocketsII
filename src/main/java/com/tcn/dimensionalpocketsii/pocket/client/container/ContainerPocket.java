...
public class ContainerPocket extends Container {
	...
	public static ContainerPocket createContainerServerSide(int windowID, PlayerInventory playerInventory, TileEntityPocket chestContents, BlockPos pos) {
		return new ContainerPocket(windowID, playerInventory, chestContents, pos);
	}

	public static ContainerPocket createContainerClientSide(int windowID, PlayerInventory playerInventory, net.minecraft.network.PacketBuffer extraData) {
		BlockPos pos = extraData.readBlockPos();
		
		return new ContainerPocket(windowID, playerInventory, new TileEntityPocket(), pos);
	}
	
	private final World world;
	private final BlockPos pos;
	
	protected ContainerPocket(int id, PlayerInventory playerInventoryIn, TileEntityPocket contentsIn, BlockPos pos) {
		super(CoreModBusManager.POCKET_CONTAINER_TYPE, id);
