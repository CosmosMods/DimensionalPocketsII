...
public class ContainerModuleBlastFurnace extends CosmosContainerRecipeBookBlockEntity<Container> {
	...
	public ContainerModuleBlastFurnace(int indexIn, Inventory playerInventoryIn, Container furnaceInventoryIn, ContainerData furnaceDataIn, BlockPos posIn) {
		super(ObjectManager.container_blast_furnace, indexIn, playerInventoryIn, null, posIn);
