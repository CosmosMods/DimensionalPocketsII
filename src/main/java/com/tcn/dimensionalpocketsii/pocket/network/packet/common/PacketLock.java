...
public class PacketLock  {
	...
	public PacketLock(PacketBuffer buf) {
	...
	public PacketLock(BlockPos pos, RegistryKey<World> dimension, boolean lock) {
		this.pos = pos;
		this.lock = lock;
		this.dimension = dimension;
	}
	
	public static void encode(PacketLock packet, PacketBuffer buf) {
