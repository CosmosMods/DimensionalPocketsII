...
public class BlockEntityModuleAnvil extends BlockEntity implements IBlockInteract, IBlockEntityUIMode, MenuProvider {
	...
	public BlockEntityModuleAnvil(BlockPos posIn, BlockState stateIn) {
		super(ObjectManager.tile_entity_anvil, posIn, stateIn);
	}
				...
				if(pocketIn.exists()) {
					if (CosmosUtil.holdingWrench(playerIn)) {
						if (pocketIn.checkIfOwner(playerIn)) {
							ItemStack stack = new ItemStack(ObjectManager.module_anvil);
	...
	public AbstractContainerMenu createMenu(int idIn, Inventory playerInventoryIn, Player playerIn) {
		return new ContainerModuleAnvil(idIn, playerInventoryIn, ContainerLevelAccess.create(this.getLevel(), this.getBlockPos()), this.getBlockPos());
	}
