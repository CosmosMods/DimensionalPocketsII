...
public class BlockWallAnvil extends BlockWallModule implements IBlankCreativeTab, EntityBlock {
	...
	public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand handIn, BlockHitResult hit) {
		...
		if (tileEntity instanceof BlockEntityModuleAnvil) {
			return ((BlockEntityModuleAnvil) tileEntity).use(state, worldIn, pos, playerIn, handIn, hit);
		}
	...
	public ItemStack getCloneItemStack(BlockGetter blockReader, BlockPos posIn, BlockState stateIn) {
       return new ItemStack(ObjectManager.module_anvil);
    }
}