...
import com.zeher.zeherlib.api.core.interfaces.IWrench;
...
public class ModUtil {
	...
	public static final void sendPlayerMessage(World world, PlayerEntity playerIn, String message) {
		if (!world.isRemote) {
	...
	public static boolean isHoldingHammer(PlayerEntity player) {
		...
		if (currentItem instanceof IWrenchAdvanced) {
			return ((IWrenchAdvanced) currentItem).isActive(player.inventory.getCurrentItem());
