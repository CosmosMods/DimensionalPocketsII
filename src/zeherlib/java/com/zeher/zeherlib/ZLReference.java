...
public class ZLReference {
	...
	public static class JEI {
		public static final String GRINDER_UID = ZeherLib.MOD_ID + ":grinder";
		
		public static final String COMPACTOR_UID = ZeherLib.MOD_ID + ":compactor";
		
		public static final String SEPARATOR_UID = ZeherLib.MOD_ID + ":separator";
		
		public static final String SYNTHESISER_UID = ZeherLib.MOD_ID + ":synthesiser";
