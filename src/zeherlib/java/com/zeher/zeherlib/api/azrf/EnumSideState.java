...
public enum EnumSideState implements IStringSerializable {
	...
	INTERFACE_NORMAL(0, "interface_normal", "side_state.interface_normal.name", 0x0000FF, TextHelper.PURPLE),
	...
	DISABLED(3, "disabled", "side_state.disabled.name", 0xFF0000, TextHelper.RED);
