...
public enum EnumConnectionType implements IStringSerializable {
	BLANK(0, "blank", "connection_type.blank.name", 0xB5B5B5, TextHelper.LIGHT_GRAY),
	...
	/** All states in [BLANK-ENERGY-FLUID-ITEM] order. */
	...
	/**
	 * Get the index of this EnumConnectionType. Order is [NO_CONN-BLANK-ENERGY-FLUID-ITEM].
	 */
	public int getIndex() {
		return this.index;
	}
