...
public class BlockContainerRemovable extends ModBlockContainer {
	...
	public BlockContainerRemovable(Block.Properties builder, String name) {//, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
		super(builder);
	}
