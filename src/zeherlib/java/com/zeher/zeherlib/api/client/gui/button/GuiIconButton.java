...
public class GuiIconButton extends GuiButton {
	...
	public GuiIconButton(int buttonId, int x, int y, int identifier, boolean enabled) {
		this(buttonId, x, y, 20, identifier, enabled);
	}

	public GuiIconButton(int buttonId, int x, int y, int size, int identifier, boolean enabled) {
