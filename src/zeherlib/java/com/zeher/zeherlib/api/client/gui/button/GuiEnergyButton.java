...
public class GuiEnergyButton extends Widget {
	...
	public GuiEnergyButton(int x, int y, int identifier, boolean enabled) {
		this(x, y, 20, identifier, enabled);
	}

	public GuiEnergyButton(int x, int y, int size, int identifier, boolean enabled) {
		super(x, y, size, size, "");
		this.width = size;
		this.height = size;
		this.size = size;
