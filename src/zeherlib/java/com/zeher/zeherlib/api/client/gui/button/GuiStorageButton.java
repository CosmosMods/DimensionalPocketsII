...
public class GuiStorageButton extends GuiButton {
	...
	public GuiStorageButton(int buttonId, int x, int y, int identifier, boolean enabled) {
		this(buttonId, x, y, 20, identifier, enabled);
	}

	public GuiStorageButton(int buttonId, int x, int y, int size, int identifier, boolean enabled) {
