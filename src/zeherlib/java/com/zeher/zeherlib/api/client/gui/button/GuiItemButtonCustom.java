...
public class GuiItemButtonCustom extends GuiButton {
	...
	public GuiItemButtonCustom(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float ticks) {
		if (this.visible) {
			...
			mc.getTextureManager().bindTexture(ZLReference.RESOURCE.BASE.GUI_ITEM_BUTTON_CUSTOM_LOC);
