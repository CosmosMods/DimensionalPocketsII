...
public class GuiListElement extends FocusableGui {
	...
	public void drawElement(Minecraft mc, FontRenderer font_renderer, int[] screen_coords, int mouseX, int mouseY, int index) {
		if (this.skin != null) {
		...
		if (this.height == 20) {
			if (this.selected) {
				this.blit(this.xPosition, this.yPosition, 56, 0 + 1 * 20, this.width / 2, this.height);
				this.blit(this.xPosition + this.width / 2, this.yPosition, 256 - this.width / 2, 0 + 1 * 20, this.width / 2, this.height);
			} else {
			...
			if (this.selected) {
				this.blit(this.xPosition, this.yPosition, 56, 42 + 1 * 14, this.width / 2, this.height);
				this.blit(this.xPosition + this.width / 2, this.yPosition, 256 - this.width / 2, 42 + 1 * 14, this.width / 2, this.height);
			} else {
				this.blit(this.xPosition, this.yPosition, 56, 42 + i * 14, this.width / 2, this.height);
				this.blit(this.xPosition + this.width / 2, this.yPosition, 256 - this.width / 2, 42 + i * 14, this.width / 2, this.height);
			}
		} else {
			if (this.selected) {
		...
		if (index == 0) {
			this.drawCenteredString(font_renderer, this.displayString + " [Owner]", this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, this.text_colour);
		} else {
